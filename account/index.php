...
<head>
    ...
    <meta name="keyword" content="pipe, monitoring, crack, corrosion, building">
    ...
    <section>
        ...
        <div class="body-content" >
            ...
            <div class="page-head" style="text-align: center;">
                <h3>
                    <a href="index.php" style="color: #91918E;">Dashboard</a>
                </h3>
                		<a href="index.php">
											<span class="sub-title">Welcome to Sonoptics dashboard</span>
										</a>
            </div>
            ...
            <div class="wrapper">
                    ...
                    <a class="btn btn-success" data-toggle="modal" href="#myModal2"><i class="fa fa-plus" style="margin-right: 13px"></i>Add Location</a>
                    <!-- Modal -->
             	...
             	<?php
									...
									foreach($location as $keys=>$values)
									{
										foreach($values as $key=>$value)
										{
												if($keys=='name') break;
							?>
              <input type="text" name="<?php echo $location['name'][$key] ?>" class="registrationBox form-control" placeholder="<?php echo $location['label'][$key]?>" autofocus="" style="
					...
					<div class="modal-footer" style="margin-top: 35px;">
							...
							<div class="row">    
								...
								<div class="col-lg-6">
									<section class="panel">
										<header class="panel-heading">
											<span class="green-color">Park Avenue</span> 
											<span class="tools pull-right">
												<a class="fa fa-repeat box-refresh" href="javascript:;"></a>
												<a class="t-collapse fa fa-chevron-down" href="javascript:;"></a>
												<a class="t-close fa fa-times" href="javascript:;"></a>
											...
											">
												...
												<tbody>
													<tr style>
														...
														<td id="quick-table-content">70 Park Ave, New York, NY 10016
														</td>
													</tr>
													<tr>
														<td id="quick-table-icon">
														...
														<td id="quick-table-content">8 devices
														</td>
													</tr>
													<tr>
														<td id="quick-table-icon">
								...
								<div class="col-lg-6">
									<section class="panel">
										<header class="panel-heading"> 
											<span class="green-color">Columbus Circle</span> 
											<span class="tools pull-right">
												<a class="fa fa-repeat box-refresh" href="javascript:;"></a>
												<a class="t-collapse fa fa-chevron-down" href="javascript:;"></a>
												<a class="t-close fa fa-times" href="javascript:;"></a>
								...
								<div class="col-lg-6">
									<section class="panel">
										<header class="panel-heading"> 
											<span class="red-color">Broadway</span>
											<span class="tools pull-right">
												<a class="fa fa-repeat box-refresh" href="javascript:;"></a>
												<a class="t-collapse fa fa-chevron-down" href="javascript:;"></a>
												<a class="t-close fa fa-times" href="javascript:;"></a>
