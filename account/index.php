        ...
        <div class="body-content" >
            ...
            <div class="wrapper">
                    ...
                    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
						...
						<form method="post" action="location.php" name="location">
             	...
             	<?php
									...
									foreach($location as $keys=>$values)
									{
										foreach($values as $key=>$value)
										{
												if($keys=='name') break;
							?>
              <input type="text" id="<?php echo $location['name'][$key] ?>" name="<?php echo $location['name'][$key] ?>"
										 class="registrationBox form-control" placeholder="<?php echo $location['label'][$key]?>" autofocus=""
										 style="background-color: transparent;border-color: #55b786;color: black;"required>
							<?php
									  }
								  }
							?>
